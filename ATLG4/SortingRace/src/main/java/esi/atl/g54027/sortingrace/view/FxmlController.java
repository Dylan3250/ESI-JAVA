package esi.atl.g54027.sortingrace.view;

import esi.atl.g54027.sortingrace.model.Quantity;
import esi.atl.g54027.sortingrace.model.Result;
import esi.atl.g54027.sortingrace.model.SortType;
import esi.atl.g54027.sortingrace.model.SortingRace;
...
public class FxmlController implements PropertyChangeListener {
    ...
    void about(ActionEvent event) {
        ...
        alert.setHeaderText("Informations diverses");
        var sb = new StringBuilder("Créé par Dylan BRICAR 54027 à l'HE2B ESI pour un mini-projet de ATL en 2ème.\n\n");
        sb.append("Plusieurs algorithmes de tri sont disponibles :\n");
        sb.append("- Choisissez le nombre de thread souhaité (afin que plusieurs parcelle du tableau a trier soient fait en même temps)\n");
        sb.append("- Prendre le tri que vous souhaitez.\n");
        sb.append("- Cliquer sur le bouton \" Start \" pour laisser opérer la magie !\n\n");
        sb.append("Les opérations sont le nombre de fois qu'il y a une comparaison ou une assignation dans le code du tri.");
