...
/**
 * Defines the line chart for Height VS BMR of the application.
 *
 * @author Dylan Bricar (54027) <54027@etu.he2b.be>
 */
public class LCHeightBMR extends LineChart<Number, Number>
    ...
    /**
     * Makes the line chart for Height VS BMR of the application.
     *
     * @param view the given View to get given information
     */
    public LCHeightBMR(View view) {
        super(new NumberAxis(), new NumberAxis());
        this.view = view;

        this.setTitle("Taille vs Indice BMR");
        this.getXAxis().setLabel("Taille (cm)");
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        // Add new point for Height vs BMR
