...
public class Memory {
    ...
    public static int[] initCards(int n) {
        if (n <= 0) {
            throw new IllegalArgumentException("Le nombre de carte doit"
    ...
    public static boolean toReturn(int[] cards, boolean[] feedback,
            int i, int j) {
        boolean toReturnCards = cards[i] == cards[j] && j != i;
    ...
    public static void main(String[] args) {
        ...
        while (!isAllReturned(feedback)) {
            ...
            System.out.print("Veuillez indiquer les deux indices [X Y]: ");
